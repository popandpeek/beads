...
func init() {
	...
	searchCmd.Flags().StringP("status", "s", "", "Filter by stored status (open, working, blocked, deferred, closed, all). Default excludes closed; use 'all' to include closed. Note: dependency-blocked issues use 'bd blocked'")
